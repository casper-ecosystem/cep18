...
fn random_string() -> String {
    ...
    let n: u64 = range.gen_range(1, 1000000000000);
    n.to_string()
}
...
fn test_mint_and_burn_tokens() {
    ...
    let mint_request = ExecuteRequestBuilder::contract_call_by_hash(
        *DEFAULT_ACCOUNT_ADDR,
        ...
        runtime_args! {
            ...
            AMOUNT => U256::from(TOKEN_OWNER_AMOUNT_1),
            "mintid" => random_string()
        },
    )
    .build();
    ...
    let mint_request_2 = ExecuteRequestBuilder::contract_call_by_hash(
        *DEFAULT_ACCOUNT_ADDR,
        cep18_token,
        METHOD_MINT,
        runtime_args! {"recipient" => TOKEN_OWNER_ADDRESS_2, AMOUNT => U256::from(TOKEN_OWNER_AMOUNT_2), "mintid" => random_string()},
    )
    .build();
...
fn test_should_not_mint_above_limits() {
    ...
    let mint_request = ExecuteRequestBuilder::contract_call_by_hash(
        *DEFAULT_ACCOUNT_ADDR,
        cep18_token,
        METHOD_MINT,
        runtime_args! {"recipient" => TOKEN_OWNER_ADDRESS_1, AMOUNT => U256::from(TOKEN_OWNER_AMOUNT_1), "mintid" => random_string()},
    )
    .build();
    builder.exec(mint_request).expect_success().commit();
    let mint_request_2 = ExecuteRequestBuilder::contract_call_by_hash(
